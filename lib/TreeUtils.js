...
var TreeUtils = function () {
	function TreeUtils() {
		var rootPath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Seq)();
		var idKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'id';
		var childNodesKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'childNodes';
		(0, _classCallCheck3.default)(this, TreeUtils);
  ...
  */
	...
	(0, _createClass3.default)(TreeUtils, [{
		key: 'id',
   ...
   */
		...
		key: 'nodes',
		value: _regenerator2.default.mark(function nodes(state, path) {
			var stack, keyPath, item, childNodes, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, i;

			return _regenerator2.default.wrap(function nodes$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						...
						case 5:
							...
							for (_iterator = (0, _getIterator3.default)(item.get(this._childNodesKey).keys()); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
								i = _step.value;
   ...
   */
		...
		value: function find(state, comparator, path) {
			...
			try {
				for (var _iterator2 = (0, _getIterator3.default)(this.nodes(state, path)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
   ...
   */
		...
		value: function filter(state, comparator, path) {
			...
			try {
				for (var _iterator3 = (0, _getIterator3.default)(this.nodes(state, path)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
   ...
   */
		...
		value: function siblings(state, idOrKeyPath) {
			...
			if (exists(item)) {
				...
				try {
					for (var _iterator4 = (0, _getIterator3.default)(item.keys()), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
						var i = _step4.value;
